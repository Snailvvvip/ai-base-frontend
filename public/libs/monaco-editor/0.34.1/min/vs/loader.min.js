"use strict";
var define, AMDLoader, _amdLoaderGlobal = this, _commonjsGlobal = "object" == typeof global ? global : {};
!function(e) {
  function t() {
    this._detected = !1,
      this._isWindows = !1,
  ...
  e.global = _amdLoaderGlobal,
    ...
    t.prototype._detect = function() {
      this._detected || (this._detected = !0,
        ...
        this._isElectronNodeIntegrationWebWorker = this._isWebWorker && "undefined" != typeof process && void 0 !== process.versions && void 0 !== process.versions.electron && "worker" === process.type)
    }
    ,
  ...
  function(r) {
    ...
    r.LoaderEventRecorder = e,
      o.prototype.record = function(e, t) {}
      ,
      ...
      ,
      o.INSTANCE = new o,
      r.NullLoaderEventRecorder = o
  }(AMDLoader = AMDLoader || {}),
  function(e) {
    function n() {}
    n.fileUriToFilePath = function(e, t) {
      if (t = decodeURI(t).replace(/%23/g, "#"),
        e) {
        if (/^file:\/\/\//.test(t))
          return t.substr(8);
        if (/^file:\/\//.test(t))
      ...
      n.recursiveClone = function(e) {
        if (!e || "object" != typeof e || e instanceof RegExp || !Array.isArray(e) && Object.getPrototypeOf(e) !== Object.prototype)
          return e;
      ...
      n.getHighPerformanceTimestamp = function() {
        return this.PERFORMANCE_NOW_PROBED || (this.PERFORMANCE_NOW_PROBED = !0,
          ...
          (this.HAS_PERFORMANCE_NOW ? e.global.performance : Date).now()
      }
      ,
  ...
  function(d) {
    function r(e) {
      ...
      return e.stack && (t.stack = e.stack),
        t
    }
    d.ensureError = r;
    n.validateConfigurationOptions = function(e) {
      var t;
      return "string" != typeof (e = e || {}).baseUrl && (e.baseUrl = ""),
      "boolean" != typeof e.isBuild && (e.isBuild = !1),
      "object" != typeof e.buildForceInvokeFactory && (e.buildForceInvokeFactory = {}),
      "object" != typeof e.paths && (e.paths = {}),
      "object" != typeof e.config && (e.config = {}),
      void 0 === e.catchError && (e.catchError = !1),
      void 0 === e.recordStats && (e.recordStats = !1),
      "string" != typeof e.urlArgs && (e.urlArgs = ""),
      "function" != typeof e.onError && (e.onError = function(e) {
          if ("loading" === e.phase)
            return console.error('Loading "' + e.moduleId + '" failed'),
              console.error(e),
              console.error("Here are the modules that depend on it:"),
              void console.error(e.neededBy);
          "factory" === e.phase && (console.error('The factory function of "' + e.moduleId + '" has thrown an exception'),
            console.error(e),
            console.error("Here are the modules that depend on it:"),
            console.error(e.neededBy))
        }
      ),
      Array.isArray(e.ignoreDuplicateModules) || (e.ignoreDuplicateModules = []),
      0 < e.baseUrl.length && (d.Utilities.endsWith(e.baseUrl, "/") || (e.baseUrl += "/")),
      "string" != typeof e.cspNonce && (e.cspNonce = ""),
      void 0 === e.preferScriptTags && (e.preferScriptTags = !1),
      Array.isArray(e.nodeModules) || (e.nodeModules = []),
      e.nodeCachedData && "object" == typeof e.nodeCachedData && ("string" != typeof e.nodeCachedData.seed && (e.nodeCachedData.seed = "seed"),
      ("number" != typeof e.nodeCachedData.writeDelay || e.nodeCachedData.writeDelay < 0) && (e.nodeCachedData.writeDelay = 7e3),
      !e.nodeCachedData.path || "string" != typeof e.nodeCachedData.path) && ((t = r(new Error("INVALID cached data configuration, 'path' MUST be set"))).phase = "configuration",
        e.onError(t),
        e.nodeCachedData = void 0),
        e
    }
      ,
    ...
    function t(e, t) {
      var r, n;
      this._env = e,
        this.options = o.mergeConfigurationOptions(t),
        this._createIgnoreDuplicateModulesMap(),
        this._createNodeModulesMap(),
        this._createSortedPathsRules(),
      "" === this.options.baseUrl && (this.options.nodeRequire && this.options.nodeRequire.main && this.options.nodeRequire.main.filename && this._env.isNode && (r = this.options.nodeRequire.main.filename,
        n = Math.max(r.lastIndexOf("/"), r.lastIndexOf("\\")),
        this.options.baseUrl = r.substring(0, n + 1)),
      this.options.nodeMain && this._env.isNode && (r = this.options.nodeMain,
        n = Math.max(r.lastIndexOf("/"), r.lastIndexOf("\\")),
        this.options.baseUrl = r.substring(0, n + 1)))
    }
    d.ConfigurationOptionsUtil = o,
      ...
      t.prototype._createSortedPathsRules = function() {
        ...
        this.sortedPathsRules = [],
          d.Utilities.forEachProperty(this.options.paths, function(e, t) {
      ...
      t.prototype._applyPaths = function(e) {
        for (var t, r = 0, n = this.sortedPathsRules.length; r < n; r++)
          if (t = this.sortedPathsRules[r],
            d.Utilities.startsWith(e, t.from)) {
            for (var o = [], i = 0, s = t.to.length; i < s; i++)
              o.push(t.to[i] + e.substr(t.from.length));
            return o
          }
        return [e]
      }
      ...
      t.prototype.moduleIdToPaths = function(e) {
        if (this._env.isNode && (!0 === this.nodeModulesMap[e] || this.options.amdModulesPattern instanceof RegExp && !this.options.amdModulesPattern.test(e)))
          return this.isBuild() ? ["empty:"] : ["node|" + e];
        if (d.Utilities.endsWith(e, ".js") || d.Utilities.isAbsolutePath(e))
          d.Utilities.endsWith(e, ".js") || d.Utilities.containsQueryString(e) || (e += ".js"),
            t = [e];
        else
          for (var t, r = 0, n = (t = this._applyPaths(e)).length; r < n; r++)
            this.isBuild() && "empty:" === t[r] || (d.Utilities.isAbsolutePath(t[r]) || (t[r] = this.options.baseUrl + t[r]),
            d.Utilities.endsWith(t[r], ".js") || d.Utilities.containsQueryString(t[r]) || (t[r] = t[r] + ".js"));
        return this._addUrlArgsIfNecessaryToUrls(t)
      }
      ,
      t.prototype.requireToUrl = function(e) {
        return d.Utilities.isAbsolutePath(e) || (e = this._applyPaths(e)[0],
        d.Utilities.isAbsolutePath(e) || (e = this.options.baseUrl + e)),
          this._addUrlArgsIfNecessaryToUrl(e)
      }
      ,
      ...
      ,
      t.prototype.shouldInvokeFactory = function(e) {
        return !this.options.isBuild || (this.options.buildForceInvokeFactory[e] || d.Utilities.isAnonymousModule(e))
      }
      ,
  ...
  function(_) {
    r.prototype.load = function(e, t, r, n) {
      var o = this
        , i = (this._scriptLoader || (this._env.isWebWorker ? this._scriptLoader = new d : this._env.isElectronRenderer ? (i = e.getConfig().getOptionsLiteral().preferScriptTags,
        this._scriptLoader = i ? new s : new a(this._env)) : this._env.isNode ? this._scriptLoader = new a(this._env) : this._scriptLoader = new s),
        {
          callback: r,
          errorback: n
        });
      this._callbackMap.hasOwnProperty(t) ? this._callbackMap[t].push(i) : (this._callbackMap[t] = [i],
    ...
    ;
    var t = r
      , s = (e.prototype.attachListeners = function(e, t, r) {
      function n() {
      ...
      e.prototype.load = function(e, t, r, n) {
        if (/^node\|/.test(t)) {
          var o = e.getConfig().getOptionsLiteral()
            , o = v(e.getRecorder(), o.nodeRequire || _.global.nodeRequire)
            , i = t.split("|")
            , s = null;
          try {
            s = o(i[1])
          ...
          o = document.createElement("script"),
            i = (o.setAttribute("async", "async"),
              o.setAttribute("type", "text/javascript"),
              this.attachListeners(o, r, n),
              e.getConfig().getOptionsLiteral().trustedTypesPolicy),
            r = (i && (t = i.createScriptURL(t)),
              o.setAttribute("src", t),
              e.getConfig().getOptionsLiteral().cspNonce);
    ...
    n.prototype._canUseEval = function(e) {
      return null === this._cachedCanUseEval && (this._cachedCanUseEval = function(e) {
        e = e.getConfig().getOptionsLiteral().trustedTypesPolicy;
        try {
          return (e ? self.eval(e.createScript("", "true")) : new Function("true")).call(self),
            !0
        } catch {
          return !1
        }
      ...
      ,
      n.prototype.load = function(e, t, r, n) {
        if (/^node\|/.test(t)) {
          var o = e.getConfig().getOptionsLiteral()
            , o = v(e.getRecorder(), o.nodeRequire || _.global.nodeRequire)
            , i = t.split("|")
          ...
          var d = e.getConfig().getOptionsLiteral().trustedTypesPolicy;
          if (!(/^((http:)|(https:)|(file:))/.test(t) && t.substring(0, self.origin.length) !== self.origin) && this._canUseEval(e))
            fetch(t).then(function(e) {
              ...
              e = e + `
//# sourceURL=` + t,
                (d ? self.eval(d.createScript("", e)) : new Function(e)).call(self),
                r()
            }).then(void 0, n);
          else
            try {
              d && (t = d.createScriptURL(t)),
                importScripts(t),
                r()
            } catch (e) {
              n(e)
    ...
    var d = n
      ...
      this._didInitialize || (this._didInitialize = !0,
        this._fs = e("fs"),
        this._vm = e("vm"),
        this._path = e("path"),
      ...
      g.prototype._initNodeRequire = function(e, u) {
        ...
        function p(r) {
          ...
          return (e.resolve = function(e, t) {
            ...
            e.extensions = n._extensions,
            e.cache = n._cache,
            e
        }
        h && !this._didPatchNodeRequire && (this._didPatchNodeRequire = !0,
            l = this,
            (c = e("module")).prototype._compile = function(e, t) {
              var e = c.wrap(e.replace(/^#!.*/, ""))
                , r = u.getRecorder()
                , n = l._getCachedDataPath(h, t)
                , o = {
                filename: t
              };
              try {
                var i = l._fs.readFileSync(n)
                  , s = i.slice(0, 16);
                o.cachedData = i.slice(16),
                  r.record(60, n)
              } catch {
                r.record(61, n)
              }
              var i = new l._vm.Script(e,o)
                , r = i.runInThisContext(o)
                , d = l._path.dirname(t)
                , a = p(this)
                , a = [this.exports, a, this, t, d, process, _commonjsGlobal, Buffer]
                , t = r.apply(this.exports, a);
              return l._handleCachedData(i, e, n, !o.cachedData, u),
                l._verifyCachedData(i, e, n, s, u),
                t
            }
        )
      }
      ...
      g.prototype.load = function(o, e, i, s) {
        ...
        if (/^node\|/.test(e)) {
          ...
          this._readSourceAndCachedData(c, f, n, function(e, t, r, n) {
            e ? s(e) : (e = t.charCodeAt(0) === g._BOM ? g._PREFIX + t.substring(1) + g._SUFFIX : g._PREFIX + t + g._SUFFIX,
              e = a(e, c),
              t = d._createAndEvalScript(o, e, {
                filename: h,
                cachedData: r
              }, i, s),
              d._handleCachedData(t, e, f, p && !r, o),
              d._verifyCachedData(t, e, f, n, o))
          })
        }
      }
      ,
      g.prototype._createAndEvalScript = function(e, t, r, n, o) {
        ...
        var s = e.getRecorder()
          , t = (s.record(31, r.filename),
          new this._vm.Script(t,r))
          , d = t.runInThisContext(r)
          , a = e.getGlobalAMDDefineFunc()
          , u = !1;
        return i.amd = a.amd,
          d.call(_.global, e.getGlobalAMDRequireFunc(), i, r.filename, this._path.dirname(r.filename)),
          s.record(32, r.filename),
          u ? n() : o(new Error("Didn't receive define call in " + r.filename + "!")),
          t
      }
      ,
      ...
      g.prototype._handleCachedData = function(t, r, n, e, o) {
        ...
        t.cachedDataRejected ? this._fs.unlink(n, function(e) {
          o.getRecorder().record(62, n),
            i._createAndWriteCachedData(t, r, n, o),
      ...
      g.prototype._createAndWriteCachedData = function(t, r, n, o) {
        var i = this
          ...
          setTimeout(function() {
            ...
            0 === e.length || e.length === s || 5 <= d || (e.length < s ? u() : (s = e.length,
              i._fs.writeFile(n, Buffer.concat([a, e]), function(e) {
                e && o.getConfig().onError(e),
                  o.getRecorder().record(63, n),
                  u()
              })))
          }, e * Math.pow(4, d++))
        };
      ...
      g.prototype._readSourceAndCachedData = function(e, r, n, t) {
        ...
        r ? (s = i = o = void 0,
          ...
          this._fs.readFile(r, function(e, t) {
            !e && t && 0 < t.length ? (s = t.slice(0, 16),
              i = t.slice(16),
              n.record(60, r)) : n.record(61, r),
              a()
          })) : this._fs.readFile(e, {
          encoding: "utf8"
        }, t)
      ...
      g.prototype._verifyCachedData = function(e, t, r, n, o) {
        ...
        n && !e.cachedDataRejected && setTimeout(function() {
          ...
          n.equals(e) || (o.getConfig().onError(new Error("FAILED TO VERIFY CACHED DATA, deleting stale '" + r + "' now, but a RESTART IS REQUIRED")),
      ...
      ,
      g._BOM = 65279,
      g._PREFIX = "(function (require, define, __filename, __dirname) { ",
      g._SUFFIX = `
});`,
      g);
    function g(e) {
    ...
    function v(t, r) {
      ...
      return e.__$__isRecorded = !0,
        e
    }
    _.ensureRecordedNodeRequire = v,
      _.createScriptLoader = function(e) {
        return new t(e)
      }
  }(AMDLoader = AMDLoader || {}),
  function(i) {
    t._normalizeModuleId = function(e) {
      for (var t = e, r = /\/\.\//; r.test(t); )
        t = t.replace(r, "/");
      for (t = t.replace(/^\.\//g, ""),
             r = /\/(([^\/])|([^\/][^\/\.])|([^\/\.][^\/])|([^\/][^\/][^\/]+))\/\.\.\//; r.test(t); )
        t = t.replace(r, "/");
      ...
      t.prototype.resolveModule = function(e) {
        return i.Utilities.isAbsolutePath(e) || (i.Utilities.startsWith(e, "./") || i.Utilities.startsWith(e, "../")) && (e = t._normalizeModuleId(this.fromModulePath + e)),
          e
      }
      ,
      t.ROOT = new t("");
    ...
    s._safeInvokeFunction = function(e, t) {
      ...
      ,
      s._invokeFactory = function(e, t, r, n) {
        return e.shouldInvokeFactory(t) ? e.shouldCatchError() ? this._safeInvokeFunction(r, n) : {
      ...
      ,
      s.prototype.complete = function(e, t, r, n) {
        this._isComplete = !0;
        var o = null;
        this._callback && ("function" == typeof this._callback ? (e.record(21, this.strId),
          o = (r = s._invokeFactory(t, this.strId, this._callback, r)).producedError,
          e.record(22, this.strId),
        o || void 0 === r.returnedValue || this.exportsPassedIn && !i.Utilities.isEmpty(this.exports) || (this.exports = r.returnedValue)) : this.exports = this._callback),
        o && ((e = i.ensureError(o)).phase = "factory",
          e.moduleId = this.strId,
          e.neededBy = n(this.id),
          this.error = e,
          t.onError(e)),
      ...
      s.prototype.onDependencyError = function(e) {
        return this._isComplete = !0,
          this.error = e,
        !!this._errorback && (this._errorback(e),
          !0)
      }
      ,
    ...
    var u = function(e, t, r) {
      ...
      l._findRelevantLocationInStack = function(e, t) {
        for (var r = function(e) {
          ...
          if (s) {
            ...
            if ((d = r(d = d.substr(u))) === n)
              return 1 === (u = {
                line: parseInt(a, 10),
                col: parseInt(s, 10)
              }).line && (u.col -= "(function (require, define, __filename, __dirname) { ".length),
                u
          }
        }
      ...
      l.prototype.getBuildInfo = function() {
        ...
        for (var e = [], t = 0, r = 0, n = this._modules2.length; r < n; r++) {
          ...
          d && (o = this._buildInfoPath[d.id] || null,
            i = this._buildInfoDefineStack[d.id] || null,
            s = this._buildInfoDependencies[d.id],
            e[t++] = {
              id: d.strId,
              path: o,
      ...
      l.prototype.getRecorder = function() {
        return this._recorder || (this._config.shouldRecordStats() ? this._recorder = new i.LoaderEventRecorder(this._loaderAvailableTimestamp) : this._recorder = i.NullLoaderEventRecorder.INSTANCE),
          this._recorder
      }
      ,
      ...
      l.prototype.enqueueDefineAnonymousModule = function(e, t) {
        ...
        var r = null;
        this._config.isBuild() && (r = new Error("StackLocation").stack || null),
      ...
      l.prototype.defineModule = function(e, t, r, n, o, i) {
        var s = this
          , d = (void 0 === i && (i = new a(e)),
          this._moduleIdProvider.getModuleId(e));
        this._modules2[d] ? this._config.isDuplicateMessageIgnoredFor(e) || console.warn("Duplicate definition of module '" + e + "'") : (e = new h(d,e,this._normalizeDependencies(t, i),r,n,i),
          this._modules2[d] = e,
        this._config.isBuild() && (this._buildInfoDefineStack[d] = o,
          this._buildInfoDependencies[d] = (e.dependencies || []).map(function(e) {
      ...
      l.prototype._normalizeDependency = function(e, t) {
        ...
        if ("require" === e)
          return c.REQUIRE;
        var r, n, o = e.indexOf("!");
        return 0 <= o ? (n = t.resolveModule(e.substr(0, o)),
          o = t.resolveModule(e.substr(o + 1)),
          r = this._moduleIdProvider.getModuleId(n + "!" + o),
          n = this._moduleIdProvider.getModuleId(n),
          new u(r,n,o)) : new c(this._moduleIdProvider.getModuleId(t.resolveModule(e)))
      }
      ,
      ...
      l.prototype.configure = function(e, t) {
        ...
        this._config = t ? new i.Configuration(this._env,e) : this._config.cloneAndMerge(e),
      ...
      l.prototype._onLoad = function(e) {
        var t;
        null !== this._currentAnonymousDefineCall && (t = this._currentAnonymousDefineCall,
      ...
      l.prototype._onLoadError = function(e, t) {
        ...
        this._modules2[e] || (this._modules2[e] = new h(e,this._moduleIdProvider.getStrModuleId(e),[],function() {}
          ,null,null));
        ...
        for (d.push(e),
          ...
          var a = d.shift()
            , u = this._modules2[a]
            , l = (u && (s = u.onDependencyError(r) || s),
            this._inverseDependencies2[a]);
          if (l)
            for (o = 0,
                   i = l.length; o < i; o++) {
              var c = l[o];
      ...
      l.prototype._createRequire = function(n) {
        ...
        return e.toUrl = function(e) {
          ...
          ,
          e.__$__nodeRequire = i.global.nodeRequire,
          e
      }
      ,
      l.prototype._loadModule = function(n) {
        var e, o, i, s, d = this;
        this._modules2[n] || this._knownModules2[n] || (this._knownModules2[n] = !0,
          e = this._moduleIdProvider.getStrModuleId(n),
          o = this._config.moduleIdToPaths(e),
        this._env.isNode && (-1 === e.indexOf("/") || /^@[^\/]+\/[^\/]+$/.test(e)) && o.push("node|" + e),
          i = -1,
          (s = function(e) {
              if (++i >= o.length)
                d._onLoadError(n, e);
                ...
                var t = o[i]
                  , r = d.getRecorder();
                if (d._config.isBuild() && "empty:" === t)
                  return d._buildInfoPath[n] = t,
                    d.defineModule(d._moduleIdProvider.getStrModuleId(n), [], null, null, null),
                    void d._onLoad(n);
                r.record(10, t),
                  d._scriptLoader.load(d, t, function() {
                    d._config.isBuild() && (d._buildInfoPath[n] = t),
                      r.record(11, t),
                      d._onLoad(n)
                  }, function(e) {
                    r.record(12, t),
        ...
        if (r)
          for (var n = 0, o = r.length; n < o; n++) {
            ...
            if (i === c.EXPORTS)
              ...
              if (s && s.isComplete()) {
                if (s.error)
                  return void e.onDependencyError(s.error);
                e.unresolvedDependenciesCount--
              } else
                this._hasDependencyPath(i.id, e.id) ? (this._hasDependencyCycle = !0,
                  console.warn("There is a dependency cycle between '" + this._moduleIdProvider.getStrModuleId(i.id) + "' and '" + this._moduleIdProvider.getStrModuleId(e.id) + "'. The cyclic path follows:"),
                  (s = this._findCyclePath(i.id, e.id, 0) || []).reverse(),
                  s.push(i.id),
                  console.warn(s.map(function(e) {
                    return t._moduleIdProvider.getStrModuleId(e)
                  }).join(` =>
`)),
                  e.unresolvedDependenciesCount--) : (this._inverseDependencies2[i.id] = this._inverseDependencies2[i.id] || [],
                  this._inverseDependencies2[i.id].push(e.id),
                  i instanceof u ? (s = this._modules2[i.pluginId]) && s.isComplete() ? this._loadPluginDependency(s.exports, i) : ((s = this._inversePluginDependencies2.get(i.pluginId)) || this._inversePluginDependencies2.set(i.pluginId, s = []),
                    s.push(i),
                    this._loadModule(i.pluginId)) : this._loadModule(i.id))
            }
          }
        ...
        if (!e.isComplete()) {
          ...
          if (n)
            for (var i = 0, s = n.length; i < s; i++) {
              var d = n[i];
              d === c.EXPORTS ? o[i] = e.exports : d === c.MODULE ? o[i] = {
                id: e.strId,
                config: function() {
                  return t._config.getConfigForModule(e.strId)
                }
              } : d === c.REQUIRE ? o[i] = this._createRequire(e.moduleIdResolver) : (d = this._modules2[d.id],
                o[i] = d ? d.exports : null)
            }
          e.complete(r, this._config, o, function(e) {
            return (t._inverseDependencies2[e] || []).map(function(e) {
              return t._moduleIdProvider.getStrModuleId(e)
            })
          });
          ...
          if (this._inverseDependencies2[e.id] = null,
            ...
            for (i = 0,
              ...
              0 === u.unresolvedDependenciesCount && this._onModuleComplete(u)
            }
          ...
          if (l) {
            ...
            for (i = 0,
                   s = l.length; i < s; i++)
              this._loadPluginDependency(e.exports, l[i])
          }
        }
      }
      ,
  ...
  function(t) {
    function r(e, t, r) {
      ...
      "object" == typeof t && Array.isArray(t) || (r = t,
        ...
        e ? i.defineModule(e, t, r, null, null) : i.enqueueDefineAnonymousModule(t, r)
    }
    function e(e, t) {
      i.configure(e, t = void 0 === t ? !1 : t)
    }
    function n() {
      if (1 === arguments.length) {
        if (arguments[0]instanceof Object && !Array.isArray(arguments[0]))
          return void e(arguments[0]);
        if ("string" == typeof arguments[0])
          return i.synchronousRequire(arguments[0])
      }
      if (2 !== arguments.length && 3 !== arguments.length || !Array.isArray(arguments[0]))
        throw new Error("Unrecognized require call");
      i.defineModule(t.Utilities.generateAnonymousModule(), arguments[0], arguments[1], arguments[2], null)
    }
    var o = new t.Environment
      , i = null;
    r.amd = {
      jQuery: !0
    };
    function s() {
      var e;
      void 0 === t.global.require && "undefined" == typeof require || "function" == typeof (e = t.global.require || require) && "function" == typeof e.resolve && (e = t.ensureRecordedNodeRequire(i.getRecorder(), e),
        t.global.nodeRequire = e,
        n.nodeRequire = e,
        n.__$__nodeRequire = e),
        !o.isNode || o.isElectronRenderer || o.isElectronNodeIntegrationWebWorker ? (o.isElectronRenderer || (t.global.define = r),
          t.global.require = n) : (module.exports = n,
          require = n)
    }
    n.config = e,
      ...
      n.define = r,
      t.init = s,
    "function" == typeof t.global.define && t.global.define.amd || (i = new t.ModuleManager(o,t.createScriptLoader(o),r,n,t.Utilities.getHighPerformanceTimestamp()),
    void 0 !== t.global.require && "function" != typeof t.global.require && n.config(t.global.require),
      (define = function() {
